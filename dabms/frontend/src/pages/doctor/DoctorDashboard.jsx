  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8 animate-stagger">
        ...
        <StatsCard label="Confirmed" value={stats?.confirmed || 0} color="bg-blue-50 text-blue-600" />
        <StatsCard label="Completed" value={stats?.completed || 0} color="bg-teal-50 text-teal-600" />
        <StatsCard label="Earnings"  value={formatCurrency(stats?.earnings || 0)} color="bg-violet-50 text-violet-600" />
      </div>
      ...
      <div>
        ...
        {!recentAppointments?.length ? (
          <EmptyState title="No appointments yet" description="Your upcoming appointments will appear here." />
        ) : (
