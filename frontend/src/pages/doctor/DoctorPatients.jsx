    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 space-y-3">
          ...
          {patients.length === 0 ? (
             <EmptyState icon="👥" title="No patients yet" description="Patients will appear here after booking an appointment." />
          ) : (
            patients.map((p) => (
              <div 
                key={p._id}
            ...
            <div className="card h-full min-h-[400px] border border-slate-200 shadow-xl">
              ...
              {historyLoading ? (
                <div className="flex justify-center py-12"><Spinner /></div>
                 ...
                 <EmptyState icon="📋" title="No history found" description="There are no past appointments for this patient." />
              ) : (
